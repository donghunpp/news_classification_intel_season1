...
url = 'https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=104#&date=%2000:00:00&page=1'

options = ChromeOptions()
user_agent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36"
options.add_argument('user-agent=' + user_agent)    # 브라우저 아니면 응답 안하니까, 에이전트
...
# //*[@id="section_body"]/ul[1]/li[1]/dl/dt[2]/a        # 각자 모두 유니크한 Path를 가지고 있다.
...
df_titles.to_csv('./crawling_data/crawlng_data.csv', index = False)
